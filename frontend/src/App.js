...
<body class="bg-gray-50">
    ...
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
      <ul class="space-y-1.5">
        ...
        <li class="hs-accordion" id="account-accordion">
          ...
          <div id="account-accordion-sub" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
            <ul class="pt-2 ps-2">
              <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100" href="#">
                  Link 1
        ...
        <li class="hs-accordion" id="projects-accordion">
          ...
          <div id="projects-accordion-sub" class="hs-accordion-content w-full overflow-hidden transition-[height] duration-300 hidden">
            <ul class="pt-2 ps-2">
              <li>
                <a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100" href="#">
                  Link 1
        ...
        <li><a class="w-full flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-slate-700 rounded-lg hover:bg-gray-100" href="#">
  ...
  <div class="w-full pt-10 px-4 sm:px-6 md:px-8 lg:ps-72">
    ...
    <header>
      ...
      <h1 class="block text-2xl font-bold text-gray-800 sm:text-3xl ">Application Layout: Sidebar using Tailwind CSS</h1>
      <p class="mt-2 text-lg text-gray-800">This is a simple application layout with sidebar and header examples using Tailwind CSS.</p>
      <div class="mt-5 flex flex-col items-center gap-2 sm:flex-row sm:gap-3">
        ...
        <a class="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent text-blue-600 hover:text-blue-800 disabled:opacity-50 disabled:pointer-events-none" href="../examples.html">
